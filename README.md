...
the open. However, they often use formats that make it difficult for many applications to consume that data. Take, for instance, the New York State ISO data
...
vehicle. We charge it at home with a Level 2 charger. Now we want to determine the best time of day to charge the car.

Static time of use billing in our area marks peak usage at 2pm - 7pm
weekdays. While that's the only time the power company doesn't want
us to charge, the grid varies a lot over the course of the day to
...
All of these will be updated every time there is new information
